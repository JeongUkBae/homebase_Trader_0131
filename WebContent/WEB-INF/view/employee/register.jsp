...
<form id="form" name="form" >
	<div class="grid-container">
	    ...
	    <div class="grid-item" id="item_4"><input type="text" id="name" name="name" ></div><br />
	    <div class="grid-item" id="item_5">매니저</div>
	    <div class="grid-item" id="item_6"><input type="text" id="manager" name="manager" ></div><br />
	    <div class="grid-item" id="item_7">생년월일</div>
	    <div class="grid-item" id="item_8"><input type="text" id="birthday" name="birthday" ></div><br />
	     <div class="grid-item" id="item_1">사진</div>
	    <div class="grid-item" id="item_2"><input type="text" id="potos" name="potos" ></div><br />
	    <div class="grid-item" id="item_9">상 세</div>
	    <div class="grid-item" id="item_10"><input type="text" id="notes" name="notes" ></div><br />
